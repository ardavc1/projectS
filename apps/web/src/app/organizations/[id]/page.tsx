    ...
    <div className="max-w-screen-xl mx-auto px-8 space-y-6">
      ...
      <div className="relative">
        {organization.bannerUrl ? (
          ...
          <div className="w-full h-64 bg-gray-200 flex items-center justify-center text-gray-400 rounded-xl">
            Banner Yok
          </div>
        )}
      </div>
      ...
      {/* HEADER → LOGO + META */}
      <div className="flex flex-wrap items-center gap-6 mt-[-3.5rem] px-2">
        {/* Logo */}
        {organization.logoUrl && (
          <img
            src={organization.logoUrl}
            alt={`${organization.name} logo`}
            className="w-28 h-28 rounded-full border-4 border-white bg-white object-cover shadow-md"
          />
        )}
